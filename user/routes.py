...
@user_routes.route('/<username>/friends/<int:friends_page_number>', endpoint='profile-friends-page')
@user_routes.route('/<username>/friends', endpoint='profile-friends')
...
@user_routes.route('/confirm/<username>/<code>', methods=('GET', 'POST'))
...
@user_routes.route('/password_reset/<username>/<code>', methods=('GET', 'POST'))
def password_reset(username, code):
    ...
    if request.method == 'POST':
        ...
        if form.validate_on_submit():
            ...
            if session.get('username'):
                session.pop('username')
            return redirect(url_for('user_routes.password_reset_complete'))
...
@user_routes.route('/password_reset_complete')
